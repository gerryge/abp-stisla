using Dychar.Abp.AspNetCore.Mvc.UI.Theme.Stisla.Bundling;
using Dychar.Abp.AspNetCore.Mvc.UI.Theme.Stisla.Menus;
using Dychar.Abp.AspNetCore.Mvc.UI.Theme.Stisla.Toolbars;
...
namespace Dychar.Abp.AspNetCore.Mvc.UI.Theme.Stisla
{
    [DependsOn(
    ...
    public class AbpAspNetCoreMvcUiStislaThemeModule : AbpModule
    {
        ...
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            {
                options.FileSets.AddEmbedded<AbpAspNetCoreMvcUiStislaThemeModule>("Dychar.Abp.AspNetCore.Mvc.UI.Theme.Stisla");
            });
