...
namespace Dychar.Dyframe.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update DyframeDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update DyframeEfCoreEntityExtensionMappings to extend the IdentityUser entity
